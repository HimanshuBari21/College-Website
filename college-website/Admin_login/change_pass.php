...
$queryget = mysqli_query ($connect,"SELECT Password FROM admin WHERE Username = '$user'")or die ("Query didnt work");
...
$querychange = mysqli_query ($connect,"UPDATE `admin` SET `Password` = MD5('$newpassword') WHERE `admin`.`Username` = '$user';");
session_destroy();
die ("Your password has been changed.<a href='Admin_login_page.html'>Return </a>to the main page");
