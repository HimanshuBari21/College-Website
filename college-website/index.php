...
<body>
                ...
                <li class="nav-item">
                    <details>
                        ...
                        <a href="Faculty_Login\Faculty_Login_Page.html" target="_blank"
                            ...
                            <a href="Admin_Login\Admin_login_page.html" target="_blank"
    ...
    <div class="jumbotron text-center" id="footer" style="margin-bottom:0">
        <center><h3>Find us on Google Maps</h3></center>
        <br>
        <iframe
            ...
            style="border:0;border-radius:20px" allowfullscreen="true" id="gmap" loading="lazy">
        </iframe> 
    </div>

    <footer class="footer">
        <div class="mx-auto">
            <p>Address</p><address class="text-primary">Varkund, Daman, DNHDD - 396210</address>
            <p>Contact</p><a href="tel:+91 8849959488">Call(+91 9876543210)</a>
            <br><br>
            <p>email id</p><a href="mailto:himanshubari789@gmail.com">admin@gpdaman.com</a>
        </div>
        <br>
    </footer>
