...
$queryget = mysqli_query ($connect,"SELECT Password FROM faculty WHERE Username = '$user'")or die ("Query didnt work");
...
$querychange = mysqli_query ($connect,"UPDATE `faculty` SET `Password` = MD5('$newpassword') WHERE `faculty`.`Username` = '$user';");
session_destroy();
die ("Your password has been changed.<a href='faculty_Login_Page.html'>Return </a>to the main page");
